...
const categoryColors = {
        ...
        underLimit: { bg: 'bg-green-500/20', text: 'text-green-400', border: 'border-green-500/30' },
        overLimit: { bg: 'bg-red-500/20', text: 'text-red-400', border: 'border-red-500/30' }
    }
    ...
    <div className="space-y-8">
      <div>
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2 ">{userName}'s Dashboard</h1>
          ...
          <div className="flex items-center justify-center gap-1">
            ...
            >Limits</button>
            <button onClick={handleRefresh} className="bg-white/5 rounded-xl backdrop-blur-sm p-2">
              <RotateCcwIcon className="text-white"></RotateCcwIcon>
            </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white/5 rounded-xl backdrop-blur-sm p-6 border border-white/10">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <p className="text-2xl font-bold text-white">{formatTime(totalTimeToday)}</p>
        ...
        <div className="bg-white/5 rounded-xl backdrop-blur-sm p-6 border border-white/10">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <p className="text-2xl font-bold text-white">{Object.keys(todayData).length}</p>
        ...
        <div className="bg-white/5 rounded-xl backdrop-blur-sm p-6 border border-white/10">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <p className="text-2xl font-bold text-white">{last7Days.length > 1 ?
        ...
        <div className="bg-white/5 rounded-xl backdrop-blur-sm p-6 border border-white/10">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <p className="text-2xl font-bold text-white">{Object.keys(limits || {}).length}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white/5 rounded-xl backdrop-blur-sm p-6 border border-white/10">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={last7Days}>
              ...
              />
              <Bar dataKey="time" fill="url(#gradient)" radius={[4, 4, 0, 0]} />
              <defs>
        ...
        <div className="bg-white/5 rounded-xl backdrop-blur-sm p-6 border border-white/10">
          <h3 className="text-xl font-semibold text-white mb-6">Today's Top Apps</h3>
                ...
                <div className="space-y-3">
                  {topAppsToday.map((app, index) => (
                    <div key={app.app} className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-white text-sm font-semibold">{app.time}m</p>
      ...
      <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
        <h3 className="text-xl font-semibold text-white mb-6">Today's App Usage</h3>
        {topAppsToday.length > 0 ? (
          <div className="space-y-4">
            {Object.entries(todayData)
              ...
              .map(([app, time]) => {
                ...
                return (
                  <div key={app} className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/10">
                      ...
                      <div>
                        ...
                        {limit && (
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <button className="text-sm text-red-400" onClick={() => handleDeleteLimit(app)}>
                    ...
                    <div className="text-right">
                      <p className={`text-lg font-semibold ${isOverLimit ? 'text-red-400' : 'text-white'}`}>
                        {minutes}m
                      </p>
      ...
      {showDialog && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-slate-800 rounded-xl p-6 border border-white/10 w-full max-w-md mx-4">
            <h3 className="text-xl font-semibold text-white mb-4">Add Time Limit</h3>
