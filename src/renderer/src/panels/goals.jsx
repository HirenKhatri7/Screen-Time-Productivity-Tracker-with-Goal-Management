...
export default function Goals({ userName, activeGoalId, setActiveGoalId, preGoals, apps,handleRefresh, preProductiveTime,streak }) {
    ...
    const [productiveTime,setProductiveTime] = useState(preProductiveTime)
    

    useEffect(() => setGoals(preGoals), [preGoals]);
    useEffect(() => setProductiveTime(preProductiveTime), [preProductiveTime]);
        ...
        <div className="space-y-8 ml-64">
            <div>
                <div className="flex items-center justify-between gap-1">
                    <h1 className="text-3xl font-bold  text-gray-900 mb-2">{userName}'s Goals</h1>
                    <div className="flex items-center justify-center gap-1">
                       
                        <button className="bg-gray-200 backdrop-blur-sm rounded-xl p-2 text-gray-600 hover:text-black" onClick={() => {setShowCreateDialog(true); }}>
                ...
                <p className="text-gray-600">your goal analytics is displayed</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white rounded-xl backdrop-blur-sm p-6 border border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="text-right">
                            <p className="font-bold text-gray-900 text-2xl">{totalGoals}</p>
                ...
                <div className="bg-white rounded-xl backdrop-blur-sm p-6 border border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="text-right">
                            <p className="font-bold text-gray-900 text-2xl">{completedGoals}</p>
                ...
                <div className="bg-white rounded-xl backdrop-blur-sm p-6 border border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="text-right">
                            <p className="font-bold text-gray-900 text-2xl">{streak}</p>
                            <p className="text-gray-400">Daily Progress Streak</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl backdrop-blur-sm p-6 border border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="text-right">
                            <p className="font-bold text-gray-900 text-2xl">{productiveTime}</p>
                            <p className="text-gray-400">Today's Productive Time</p>
                        </div>
                    </div>
                </div>
            </div>

            <div className="flex bg-white rounded-lg p-1 border border-gray-300 w-fit">
                {[
                ...
                {filteredGoals.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                        {filteredGoals.map(goal => {
                            ...
                            return (
                                <Goal goal={goal} status={status} progress={progress} daysLeft={daysLeft} categoryColor={categoryColor} priorityColor={priorityColor} startEdit={startEdit} handleDeleteGoal={handleDeleteGoal} toggleSubtask={toggleSubtask} handleCompleteGoal={handleCompleteGoal} handleUncompleteGoal={handleUncompleteGoal} activeGoalId = {activeGoalId} setActiveGoalId = {setActiveGoalId}/>
                            )
                        })}
                    </div>
                )}
            ...
            {showCreateDialog && (
                <div className="fixed inset-0  flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-xl p-6 border border-gray-300 w-full max-w-2xl max-h-[90vh] overflow-y-auto ">
                        <h3 className="text-xl font-semibold text-black mb-6">Create New Goal</h3>

                        <div className="space-y-4">
                            <div>
                                <label className="block text-gray-700 text-sm font-medium mb-2">Goal Title *</label>
                                <input
                                    type="text"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select
                                        className="w-full bg-white text-black rounded-lg px-3 py-2 border-gray-300 border"
                                ...
                                <div>
                                    ...
                                    <select
                                        className="w-full bg-white text-black rounded-lg px-3 py-2 border border-gray-300"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-white/10 border border-gray-300 rounded-lg px-3 py-2 text-black placeholder-gray-400 "
                                    ...
                                    {formData.subtasks.map((subtask, index) => (
                                        <div key={index} className="flex items-center space-x-2">
                                            <input
                                                ...
                                                className="flex-1 bg-white border border-gray-300 rounded-lg px-3 py-2 text-black placeholder-gray-400"
